...
import { Search, Menu, ShoppingCart, Book } from 'lucide-react';
...
const TransactionPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#faf3e0' }}>
      {/* Header */}
      <header className="p-4 shadow-md" style={{ backgroundColor: '#6b4f4f' }}>
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <ShoppingCart className="text-white cursor-pointer hover:opacity-80" size={24} />
            <Menu className="text-white cursor-pointer hover:opacity-80" size={24} />
          </div>
        </div>
      </header>
